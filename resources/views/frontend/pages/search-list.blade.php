...
@section('content')
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (searchQuery) {
                document.getElementById('searchResultText').textContent = `Showing result “${searchQuery}”`;
            }
        });
    </script> --}}
        ...
        $(document).ready(function() {
            ...
            function renderResults(results) {
                ...
                results.forEach(function(result) {
                    ...
                    var reczItText = firstName ? `<span style="color: #000000"><span class="start_bold">${firstName}</span> and 327 <span class="start_bold">other</span> people Recz it!</span>` : '';
        ...
        $(document).ready(function() {
            ...
            function renderResults(results) {
                ...
                results.forEach(function(result) {
                    ...
                    // Extract genres from lstMeta
                    var genres = result.lstMeta.filter(meta => meta.metaID === 22).map(meta => meta.value).join(', ');
